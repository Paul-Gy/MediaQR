...
<div class="container text-center my-5">
    ...
    <h2>Cette slide n'est pas couverte dans ce cours !</h2>
    <h3 class="mb-4">Essayez une autre slide ou un autre cours</h3>
            ...
            <linearGradient v-if="Math.random() * 10 > 9" id="OYgUyNjocE5tCCup-ya0-a" x1="30.322" x2="520.436" y1="508.379" y2="18.265"
                ...
                <stop offset="0" stop-color="">
                    <animate attributeName="stop-color"
                             values="#e8b71d;#e3e81d;#1de840;#1ddde8;#2b1de8;#dd00f3;#dd00f3;#ff2400;#e81d1d" dur="2s"
                             repeatCount="indefinite"/>
                </stop>
                <stop offset=".5" stop-color="">
                    <animate attributeName="stop-color"
                             values="#e81d1d;#e8b71d;#e3e81d;#1de840;#1ddde8;#2b1de8;#dd00f3;#dd00f3;#ff2400" dur="2s"
                             repeatCount="indefinite"/>
                </stop>
                <stop offset="1" stop-color="">
                    <animate attributeName="stop-color"
                             values="#ff2400;#e81d1d;#e8b71d;#e3e81d;#1de840;#1ddde8;#2b1de8;#dd00f3;#dd00f3" dur="2s"
                             repeatCount="indefinite"/>
                </stop>
            </linearGradient>
